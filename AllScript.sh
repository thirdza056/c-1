...
if [[ -e /etc/apt/sources.list.d/pritunl.list ]]; then

echo ""
echo "ดูเหมือนว่าไอพีนี้เคยติดตั้ง Pritunl มาก่อนหน้านี้แล้ว"
echo "ไม่สามารถติดตั้ง OpenVPN (Terminal Control) ให้ได้.. เพราะระบบจะเกิดความผิดพลาด"
echo ""
if
...
echo ""
echo "ดูเหมือนว่าไอพีนี้เคยติดตั้ง OpenVPN มาก่อนหน้านี้แล้ว"
echo "ไม่สามารถติดตั้ง Pritunl ให้ได้.. เพราะระบบจะเกิดความผิดพลาด"
echo ""
fi
